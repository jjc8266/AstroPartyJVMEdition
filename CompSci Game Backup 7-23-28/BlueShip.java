...
public class BlueShip
{
   ...
   public BlueShip(double x, double y)
   {
      myX = x;
      myY = y;
   }
   public BlueShip(double x, double y, double life)
   {
      myX = x;
      myY = y;
      lives = life;
   }
   public BlueShip(double x, double y, double life, double Orientation)
   {
      myX = x;
      myY = y;
      lives = life;
   ...
   public void collideWidth(Map[] aaa)
   {
      for(int c = 0;c<aaa.length/2;c++){
         if((myX <= ((((NiceBlock)(aaa[c])).getX()+((NiceBlock)(aaa[c])).getSize())+125/2)
         && myX >= ((((NiceBlock)(aaa[c])).getX())-125/2))
         &&(myY <= ((((NiceBlock)(aaa[c])).getY()+((NiceBlock)(aaa[c])).getSize())+125/2)
         && myY >= ((((NiceBlock)(aaa[c])).getY())-125)))  
         {
            
            if(myX <= ((((NiceBlock)(aaa[c])).getX()+((NiceBlock)(aaa[c])).getSize())+125/2)) 
            {
               setX(((((NiceBlock)(aaa[c])).getX()+((NiceBlock)(aaa[c])).getSize())+125/2)+2);
               //dX = 0;
               //dY = 0;
            }
         
            if(myX >= ((((NiceBlock)(aaa[c])).getX())-125/2))
            {
               setX(((((NiceBlock)(aaa[c])).getX())-125/2)+dX);
               //dX = 0;
               //dY = 0;
            }
...
//             }
   ...
   {
      ImageIcon blueship = new ImageIcon("BS.PNG");
