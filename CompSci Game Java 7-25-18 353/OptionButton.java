...
public class OptionButton extends JPanel{
   private JButton backbutton,soundoff,soundscool,soundslame,adson,adsoff;
   public static JButton soundon;
   private ImageIcon back, sCool, sLame, aOn, aOff, theme1, theme2;
   public static ImageIcon sOn,sOff;
