...
public class BlueShip extends Ship
{
   ...
   public BlueShip(double x, double y, int life)
   {
      myX = x;
      myY = y;
   ...
   public BlueShip(double x, double y, int life, double Orientation)
   {
      myX = x;
      myY = y;
      lives = livesTemp = life;
   ...
   public void draw(Graphics myBuffer)
   {
      ...
      if(!(System.currentTimeMillis()-sTime>500)){        
         blueship= new ImageIcon("AstroBreakingBlue.gif"); 
         lives = livesTemp;                   
      }
